...
(async () => {
  ...
  db.users = [
    { id: uuidv4(), nombre: 'Administrador',  email: 'admin@restito.com',      password: hash('admin123'),    rol: 'admin',      sucursal_id: null, activo: true, createdAt: new Date().toISOString() },
    { id: uuidv4(), nombre: 'Supervisor',     email: 'supervisor@restito.com', password: hash('super123'),    rol: 'supervisor', sucursal_id: null, activo: true, createdAt: new Date().toISOString() },
    { id: uuidv4(), nombre: 'Cajero 01',      email: 'cajero01@restito.com',   password: hash('cajero123'),   rol: 'cajero',     sucursal_id: null, activo: true, createdAt: new Date().toISOString() },
    { id: uuidv4(), nombre: 'Carlos Mozo',    email: 'carlos@restito.com',     password: hash('mozo123'),     rol: 'mozo',       sucursal_id: null, activo: true, createdAt: new Date().toISOString() },
    { id: uuidv4(), nombre: 'Mozo Martín',    email: 'mozo01@restito.com',     password: hash('mozo123'),     rol: 'mozo',       sucursal_id: null, activo: true, createdAt: new Date().toISOString() },
    { id: uuidv4(), nombre: 'Mozo Laura',     email: 'mozo02@restito.com',     password: hash('mozo456'),     rol: 'mozo',       sucursal_id: null, activo: true, createdAt: new Date().toISOString() },
    { id: uuidv4(), nombre: 'Cocinero Pedro', email: 'cocinero@restito.com',   password: hash('cocina123'),   rol: 'cocinero',   sucursal_id: null, activo: true, createdAt: new Date().toISOString() },
    { id: uuidv4(), nombre: 'Repartidor 01',  email: 'repartidor@restito.com', password: hash('delivery123'), rol: 'repartidor', sucursal_id: null, activo: true, createdAt: new Date().toISOString() }
  ];
